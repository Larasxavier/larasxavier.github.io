...
Sou **Lara Xavier**, DevOps Sênior especializada em **Observabilidade**, com foco em transformar métricas, logs e traces em **decisões de negócio**(não apenas gráficos).
...
Tenho forte atuação na **comunidade técnica**, com **mais de 16 palestras sobre observabilidade**, além de **treinamentos corporativos** voltados a times de engenharia, SRE e operações.
